...
--- Gets the width and height of the CompressedImageData.
--- @return number @The width of the CompressedImageData.
--- @return number @The height of the CompressedImageData.
...
--- Gets the format of the CompressedImageData.
--- @return CompressedImageFormat @The format of the CompressedImageData.
...
--- Gets the number of mipmap levels in the CompressedImageData. The base mipmap level (original image) is included in the count.
--- @return number @The number of mipmap levels stored in the CompressedImageData.
...
--- @overload fun(outFile: string, format: ImageFormat):
function ImageData:encode(format, filename) end


--- Gets the width and height of the ImageData in pixels.
--- Gets the width and height of the ImageData in pixels.
--- @return number @The width of the ImageData in pixels.
--- @return number @The height of the ImageData in pixels.
...
--- @overload fun(x: number, y: number, color: table):
function ImageData:setPixel(x, y, r, g, b, a) end


--- Gets the pixel format of the ImageData.
--- Gets the pixel format of the ImageData.
--- @return PixelFormat @The pixel format the ImageData was created with.
