...
---
---This may be different than the number used as an argument to love.graphics.newCanvas if the system running LÖVE doesn't support that number.
--- @return number @The number of multisample antialiasing samples used by the canvas when drawing to it.
function Canvas:getMSAA() end


--- Gets the MipmapMode this Canvas was created with.
--- Gets the MipmapMode this Canvas was created with.
--- @return MipmapMode @The mipmap mode this Canvas was created with.
function Canvas:getMipmapMode() end


--- Generates ImageData from the contents of the Canvas.
--- Generates ImageData from the contents of the Canvas.
--- @return ImageData @The new ImageData made from the Canvas' contents.
...
---
---The font size of TrueType fonts is scaled internally by the font's specified DPI scale factor. By default, LÖVE uses the screen's DPI scale factor when creating TrueType fonts.
--- @return number @The DPI scale factor of the Font.
...
--- @return number @The kerning amount to add to the spacing between the two characters. May be negative.
...
--- @return number @The maximum width of the wrapped text.
--- @return table @A sequence containing each line of text that was wrapped.
--- @overload fun(coloredtext: table, wraplimit: number):number, table
...
--- @return boolean @Whether the font can render all the UTF-8 characters in the string.
...
---
---Compressed images take up less space in VRAM, and drawing a compressed image will generally be more efficient than drawing one created from raw pixel data.
--- @return boolean @Whether the Image is stored as a compressed texture on the GPU.
...
---
---This method always returns false when gamma-correct rendering is not enabled.
--- @return boolean @Whether the Image's internal pixel format is linear (not gamma corrected), when gamma-correct rendering is enabled.
...
--- @overload fun(name: string, mesh: Mesh, step: VertexAttributeStep, attachname: string):
...
--- @return boolean @Whether the attribute was successfully detached.
...
--- Gets the range of vertices used when drawing the Mesh.
--- @return number @The index of the first vertex used when drawing, or the index of the first value in the vertex map used if one is set for this Mesh.
--- @return number @The index of the last vertex used when drawing, or the index of the last value in the vertex map used if one is set for this Mesh.
...
--- @return number @The first component of the first vertex attribute in the specified vertex.
...
--- @return number @The value of the first component of the attribute.
--- @return number @The value of the second component of the attribute.
...
--- Gets the total number of vertices in the Mesh.
--- @return number @The total number of vertices in the mesh.
function Mesh:getVertexCount() end


--- Gets the vertex format that the Mesh was created with.
--- Gets the vertex format that the Mesh was created with.
--- @return table @The vertex format of the Mesh, which is a table containing tables for each vertex attribute the Mesh was created with, in the form of {attribute, ...}.
...
---
---If no vertex map has been set previously via Mesh:setVertexMap, then this function will return nil in LÖVE 0.10.0+, or an empty table in 0.9.2 and older.
--- @return table @A table containing the list of vertex indices used when drawing.
...
--- @return boolean @Whether the vertex attribute is used when drawing this Mesh.
...
--- @overload fun(data: Data, datatype: IndexDataType):
...
--- @overload fun(data: Data, startvertex: number):
...
--- Gets the maximum number of particles the ParticleSystem can have at once.
--- @return number @The maximum number of particles.
...
---
---In versions prior to 11.0, color component values were within the range of 0 to 255 instead of 0 to 1.
--- @return number @First color, red component (0-1).
--- @return number @First color, green component (0-1).
--- @return number @First color, blue component (0-1).
--- @return number @First color, alpha component (0-1).
--- @return number @Second color, red component (0-1).
--- @return number @Second color, green component (0-1).
--- @return number @Second color, blue component (0-1).
--- @return number @Second color, alpha component (0-1).
--- @return number @Eighth color, red component (0-1).
--- @return number @Eighth color, green component (0-1).
--- @return number @Eighth color, blue component (0-1).
--- @return number @Eighth color, alpha component (0-1).
...
--- Gets the direction of the particle emitter (in radians).
--- @return number @The direction of the emitter (radians).
...
--- @return number @The maximum spawn distance from the emitter along the x-axis for uniform distribution, or the standard deviation along the x-axis for normal distribution.
--- @return number @The maximum spawn distance from the emitter along the y-axis for uniform distribution, or the standard deviation along the y-axis for normal distribution.
--- @return number @The angle in radians of the emission area.
--- @return boolean @True if newly spawned particles will be oriented relative to the center of the emission area, false otherwise.
...
--- Gets the mode used when the ParticleSystem adds new particles.
--- @return ParticleInsertMode @The mode used when the ParticleSystem adds new particles.
...
--- Gets the particle image's draw offset.
--- @return number @The x coordinate of the particle image's draw offset.
--- @return number @The y coordinate of the particle image's draw offset.
function ParticleSystem:getOffset() end


--- Gets the lifetime of the particles.
--- Gets the lifetime of the particles.
--- @return number @The minimum life of the particles (in seconds).
--- @return number @The maximum life of the particles (in seconds).
...
--- Gets the series of Quads used for the particle sprites.
--- @return table @A table containing the Quads used.
...
--- Gets the amount of size variation (0 meaning no variation and 1 meaning full variation between start and end).
--- @return number @The amount of variation (0 meaning no variation and 1 meaning full variation between start and end).
...
--- @return number @The degree of variation (0 meaning no variation and 1 meaning full variation between start and end).
...
--- Gets the amount of directional spread of the particle emitter (in radians).
--- @return number @The spread of the emitter (radians).
...
--- Gets whether particle angles and rotations are relative to their velocities. If enabled, particles are aligned to the angle of their velocities and rotate relative to that angle.
--- @return boolean @True if relative particle rotation is enabled, false if it's disabled.
...
--- @overload fun(rgba1: table, ...: table):
...
--- Gets reference texture dimensions initially specified in love.graphics.newQuad.
--- @return number @The Texture width used by the Quad.
--- @return number @The Texture height used by the Quad.
...
--- @return number @The top-left corner along the y-axis.
...
--- Returns any warning and error messages from compiling the shader code. This can be used for debugging your shaders if there's anything the graphics hardware doesn't like.
--- @return string @Warning and error messages (if any).
...
--- @return boolean @Whether the uniform exists in the shader and affects its final output.
...
--- @overload fun(name: string, matrixlayout: MatrixLayout, matrix: table, ...: table):
--- @overload fun(name: string, data: Data, offset: number, size: number):
--- @overload fun(name: string, data: Data, matrixlayout: MatrixLayout, offset: number, size: number):
--- @overload fun(name: string, matrixlayout: MatrixLayout, data: Data, offset: number, size: number):
...
--- @return number @The index of the added sprite, for use with SpriteBatch:set or SpriteBatch:setLayer.
...
---
---In versions prior to 11.0, color component values were within the range of 0 to 255 instead of 0 to 1.
--- @return number @The red component (0-1).
--- @return number @The green component (0-1).
--- @return number @The blue component (0-1).
--- @return number @The alpha component (0-1).
function SpriteBatch:getColor() end


--- Gets the number of sprites currently in the SpriteBatch.
--- Gets the number of sprites currently in the SpriteBatch.
--- @return number @The number of sprites currently in the batch.
...
--- @param kx number @Shear factor (x-axis).
--- @param ky number @Shear factor (y-axis).
--- @overload fun(spriteindex: number, quad: Quad, x: number, y: number, r: number, sx: number, sy: number, ox: number, oy: number, kx: number, ky: number):
...
--- @param kx number @Shearing factor (x-axis).
--- @param ky number @Shearing factor (y-axis).
--- @overload fun(spriteindex: number, layerindex: number, quad: Quad, x: number, y: number, r: number, sx: number, sy: number, ox: number, oy: number, kx: number, ky: number):
--- @overload fun(spriteindex: number, layerindex: number, transform: Transform):
--- @overload fun(spriteindex: number, layerindex: number, quad: Quad, transform: Transform):
...
--- @return number @An index number that can be used with Text:getWidth or Text:getHeight.
...
--- Gets the width and height of the text in pixels.
--- @return number @The width of the text. If multiple sub-strings have been added with Text:add, the width of the last sub-string is returned.
--- @return number @The height of the text. If multiple sub-strings have been added with Text:add, the height of the last sub-string is returned.
...
---
---Depth texture comparison modes are advanced low-level functionality typically used with shadow mapping in 3D.
--- @return CompareMode @The comparison mode used when sampling from this texture in a shader, or nil if setDepthSampleMode has not been called on this Texture.
...
--- Gets the filter mode of the Texture.
--- @return FilterMode @Filter mode to use when minifying the texture (rendering it at a smaller size on-screen than its size in pixels).
--- @return FilterMode @Filter mode to use when magnifying the texture (rendering it at a smaller size on-screen than its size in pixels).
--- @return number @Maximum amount of anisotropic filtering used.
...
--- Gets the pixel format of the Texture.
--- @return PixelFormat @The pixel format the Texture was created with.
...
--- Gets the number of layers / slices in an Array Texture. Returns 1 for 2D, Cubemap, and Volume textures.
--- @return number @The number of layers in the Array Texture.
...
--- Gets the number of mipmaps contained in the Texture. If the texture was not created with mipmaps, it will return 1.
--- @return number @The number of mipmaps in the Texture.
...
--- Gets the mipmap filter mode for a Texture. Prior to 11.0 this method only worked on Images.
--- @return FilterMode @The filter mode used in between mipmap levels. nil if mipmap filtering is not enabled.
--- @return number @Value used to determine whether the image should use more or less detailed mipmap levels than normal when drawing.
...
---
---This function returns the currently set horizontal and vertical wrapping modes for the texture.
--- @return WrapMode @Horizontal wrapping mode of the texture.
--- @return WrapMode @Vertical wrapping mode of the texture.
--- @return WrapMode @Wrapping mode for the z-axis of a Volume texture.
...
---
---Non-readable Canvases can still be rendered to.
--- @return boolean @Whether the Texture is readable.
...
--- Gets the scaling filters used when drawing the Video.
--- @return FilterMode @The filter mode used when scaling the Video down.
--- @return FilterMode @The filter mode used when scaling the Video up.
--- @return number @Maximum amount of anisotropic filtering used.
...
--- Gets the VideoStream object used for decoding and controlling the video.
--- @return VideoStream @The VideoStream used for decoding and controlling the video.
...
--- Gets whether the Video is currently playing.
--- @return boolean @Whether the video is playing.
...
--- Gets the current playback position of the Video.
--- @return number @The time in seconds since the beginning of the Video.
...
--- @overload fun(drawable: Drawable, transform: Transform):
--- @overload fun(texture: Texture, quad: Quad, transform: Transform):
...
--- @param kx number @Shearing factor (x-axis).
--- @param ky number @Shearing factor (y-axis).
--- @overload fun(mesh: Mesh, instancecount: number, transform: Transform):
...
--- @param kx number @Shearing factor (x-axis).
--- @param ky number @Shearing factor (y-axis).
--- @overload fun(texture: Texture, layerindex: number, quad: Quad, x: number, y: number, r: number, sx: number, sy: number, ox: number, oy: number, kx: number, ky: number):
--- @overload fun(texture: Texture, layerindex: number, transform: Transform):
--- @overload fun(texture: Texture, layerindex: number, quad: Quad, transform: Transform):
...
--- @return BlendAlphaMode @The current blend alpha mode – it determines how the alpha of drawn objects affects blending.
...
--- Gets the available Canvas formats, and whether each is supported.
--- @return table @A table containing CanvasFormats as keys, and a boolean indicating whether the format is supported as values. Not all systems support all formats.
...
--- @return boolean @Whether to write update / write values to the depth buffer when rendering.
...
---
---This is designed for use in combination with Mesh face culling. Other love.graphics shapes, lines, and sprites are not guaranteed to have a specific winding order to their internal vertices.
--- @return VertexWinding @The winding mode being used. The default winding is counterclockwise ('ccw').
...
--- Gets the raw and compressed pixel formats usable for Images, and whether each is supported.
--- @return table @A table containing PixelFormats as keys, and a boolean indicating whether the format is supported as values. Not all systems support all formats.
...
---
---Mesh face culling is designed for use with low level custom hardware-accelerated 3D rendering via custom vertex attributes on Meshes, custom vertex shaders, and depth testing with a depth buffer.
--- @return CullMode @The Mesh face culling mode in use (whether to render everything, cull back-facing triangles, or cull front-facing triangles).
...
--- Gets information about the system's video card and drivers.
--- @return string @The name of the renderer, e.g. 'OpenGL' or 'OpenGL ES'.
...
--- Gets the current depth of the transform / state stack (the number of pushes without corresponding pops).
--- @return number @The current depth of the transform and state love.graphics stack.
...
--- @return number @The value used when comparing with the stencil value of each pixel.
...
---
---Some older or low-end systems don't always support all graphics features.
--- @return table @A table containing GraphicsFeature keys, and boolean values indicating whether each feature is supported.
function m.getSupported() end


--- Gets the system-dependent maximum values for love.graphics features.
--- Gets the system-dependent maximum values for love.graphics features.
--- @return table @A table containing GraphicsLimit keys, and number values.
function m.getSystemLimits() end


--- Gets the available texture types, and whether each is supported.
--- Gets the available texture types, and whether each is supported.
--- @return table @A table containing TextureTypes as keys, and a boolean indicating whether the type is supported as values. Not all systems support all types.
...
--- @return number @The x component of the position in global coordinates.
--- @return number @The y component of the position in global coordinates.
...
--- Gets whether the graphics module is able to be used. If it is not active, love.graphics function and method calls will not work correctly and may cause the program to crash.
---The graphics module is inactive if a window is not open, or if the app is in the background on iOS. Typically the app's execution will be automatically paused by the system, in the latter case.
--- @return boolean @Whether the graphics module is active and able to be used.
...
---
---Not all devices support gamma-correct rendering, in which case it will be automatically disabled and this function will return false. It is supported on desktop systems which have graphics cards that are capable of using OpenGL 3 / DirectX 10, and iOS devices that can use OpenGL ES 3.
--- @return boolean @True if gamma-correct rendering is supported and was enabled in love.conf, false otherwise.
...
--- @overload fun(text: string, transform: Transform):
--- @overload fun(coloredtext: table, transform: Transform):
--- @overload fun(text: string, font: Font, transform: Transform):
--- @overload fun(coloredtext: table, font: Font, transform: Transform):
...
--- @param kx number @Shearing factor (x-axis).
--- @param ky number @Shearing factor (y-axis).
--- @overload fun(text: string, font: Font, x: number, y: number, limit: number, align: AlignMode, r: number, sx: number, sy: number, ox: number, oy: number, kx: number, ky: number):
--- @overload fun(text: string, transform: Transform, limit: number, align: AlignMode):
--- @overload fun(text: string, font: Font, transform: Transform, limit: number, align: AlignMode):
--- @overload fun(coloredtext: table, x: number, y: number, limit: number, align: AlignMode, angle: number, sx: number, sy: number, ox: number, oy: number, kx: number, ky: number):
--- @overload fun(coloredtext: table, font: Font, x: number, y: number, limit: number, align: AlignMode, angle: number, sx: number, sy: number, ox: number, oy: number, kx: number, ky: number):
--- @overload fun(coloredtext: table, transform: Transform, limit: number, align: AlignMode):
--- @overload fun(coloredtext: table, font: Font, transform: Transform, limit: number, align: AlignMode):
...
--- @overload fun(canvas: Canvas, slice: number, mipmap: number):
...
--- @return number @The x component of the position with graphics transformations applied.
--- @return number @The y component of the position with graphics transformations applied.
...
--- @param code string @The pixel shader or vertex shader code, or a filename pointing to a file with the code.
--- @return boolean @true if specified shader code doesn't contain any errors. false otherwise.
--- @return string @Reason why shader code validation failed (or nil if validation succeded).
