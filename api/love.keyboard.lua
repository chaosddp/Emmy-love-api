...
--- @return KeyConstant @The key corresponding to the given scancode, or 'unknown' if the scancode doesn't map to a KeyConstant on the current system.
...
--- Gets whether screen keyboard is supported.
--- @return boolean @Whether screen keyboard is supported.
...
--- @return boolean @True if any supplied Scancode is down, false if not.
