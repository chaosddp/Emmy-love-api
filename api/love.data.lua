...
---@return ByteDataorstring decoded ByteData/string which contains the decoded version of source.
...
---@return Dataorstring decompressedData Data/string containing the raw decompressed data.
...
---@return Dataorstring data Data/string which contains the serialized data.
